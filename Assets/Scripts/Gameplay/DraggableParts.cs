...
public class DraggableParts : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public static DraggableParts CurrentDraggedItem { get; private set; }
    ...
    {
        if (DraggableParts.CurrentDraggedItem != null || !canDrag)
        {
            return;
        }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {
            PartSocket socket = startParent?.GetComponent<PartSocket>();
            if (socket != null)
            {
